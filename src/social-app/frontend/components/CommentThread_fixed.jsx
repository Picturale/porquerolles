    ...
    >
      ...
      <div className="comment-main-content">
        ...
        <div className="comment-footer">
          <div className="comment-footer-actions">
            ...
            {/* Compteur et toggle des réponses */}
            {hasReplies && (
              <button 
        ...
        <div className="comment-replies">
          {comment.replies.map(reply => (
            <CommentThread
              ...
              isReplyFormOpen={getReplyFormOpenState ? getReplyFormOpenState(reply.id) : false}
              getThreadOpenState={getThreadOpenState}
              getReplyFormOpenState={getReplyFormOpenState}
            />
          ))}
        </div>
      )}
      ...
      {showReplyForm && (
        <CommentReplyForm
          ...
          currentUser={currentUser}
          parentAuthor={comment.displayName || comment.username || 'ce commentaire'}
        />
      )}
    </div>
  );
