...
function CreatePost() {
  ...
  useEffect(() => {
    ...
    const loadPostForEdit = async () => {
      ...
      try {
        ...
        setShowResourcesSection(!!postData.ingredients?.trim());
  ...
  useEffect(() => {
    if (!isEditMode) {
      // Ajuster automatiquement l'affichage basé sur le contenu
      if (title.trim() && !showTitleSection) {
        setShowTitleSection(true);
      }
      if (description.trim() && !showDescriptionSection) {
        setShowDescriptionSection(true);
      }
      if (ingredients.trim() && !showResourcesSection) {
        setShowResourcesSection(true);
      }
    }
  }, [title, description, ingredients, isEditMode, showTitleSection, showDescriptionSection, showResourcesSection]);
          ...
          <form onSubmit={handleSubmit} className="create-post-form">
            {step === 'select' && (
              <div className="upload-section">
                  ...
                  >
                    ...
                    <label htmlFor="image-upload" className="upload-label">
                      <div className="upload-content">
                        ...
                        <p className="upload-hint">Formats acceptés: JPG, PNG, GIF, Vidéos</p>
                      </div>
                    </label>
                  </div>
                </div>
                            ...
                            <div className="step-image-section">
                              {step.imageStep === 'none' && (
                                <div className="step-image-upload">
                                  ...
                                  />
                                  <label htmlFor={`step-image-${step.id}`} className="step-upload-label">
                                    <span className="upload-icon">
                                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M19 16.9A5 5 0 0 0 18 7h-1.26A8 8 0 1 0 4 15.25" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                              ...
                              {step.imageStep === 'crop' && step.imageSrc && step.fileType === 'image' && (
                ...
                {/* Section ressources directement dans la page */}
            ...
            {step === 'preview' && (
              <div className="preview-section">
                ...
                {/* Section titre directement dans la page */}
                <div className="title-section">
                  <input
                    type="text"
                    id="title"
                ...
                {/* Section description directement dans la page */}
                <div className="description-section">
                  <SmartInput
                    value={description}
                    onChange={setDescription}
